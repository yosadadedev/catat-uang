...
import { View, Text, ScrollView, TouchableOpacity, Alert, Modal, Switch } from 'react-native';
...
const SettingsScreen = () => {
  ...
  const handleResetData = async () => {
    try {
      ...
      // Show loading state
      Alert.alert('Menghapus Data', 'Sedang menghapus semua data...', [], { cancelable: false });
      ...
      Alert.alert('Error', 'Gagal menghapus data. Silakan coba lagi.', [{ text: 'OK' }]);
    }
  };
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
              ...
              <View style={{ marginLeft: 12, flex: 1 }}>
                ...
                <Text style={{ color: '#6B7280', fontSize: 14 }}>
                  Hapus seluruh riwayat transaksi dan pengaturan
                </Text>
              </View>
            </View>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
