          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20 }}>
              ...
              <View style={{
                ...
                height: 60,
                borderRadius: 30,
                backgroundColor: selectedIconColor || iconColors[iconOptions.indexOf(selectedIcon) % iconColors.length] || colors.primary,
                justifyContent: 'center',
                alignItems: 'center',
                marginRight: 16,
                shadowColor: selectedIconColor || iconColors[iconOptions.indexOf(selectedIcon) % iconColors.length] || colors.primary,
                shadowOffset: { width: 0, height: 2 },
                shadowOpacity: 0.3,
                shadowRadius: 4,
                elevation: 3
